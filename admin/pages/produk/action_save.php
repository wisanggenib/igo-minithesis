...
// query untuk menyimpan ke tabel
    $querySimpan = mysqli_query($host, "INSERT INTO produk (nama_produk, gambar, harga_produk,deskripsi_produk) VALUES ('$nama_produk', '$nameFile', '$harga_produk','$deskripsi_produk')");
